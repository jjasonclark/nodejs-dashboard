...
var MILLISECONDS_PER_SECOND = constants.MILLISECONDS_PER_SECOND;
var TIME_LABEL_PATTERN = constants.TIME_LABEL_PATTERN;
var TIME_SCALES = constants.TIME_SCALES;
 ...
 */
exports.getTimeIndexLabel =
  function getTimeIndexLabel(timeIndex, aggregateTimeUnits) {
    var DIGITS_PER_UNIT = 2;

    var timeValue = timeIndex * (aggregateTimeUnits || MILLISECONDS_PER_SECOND);
    var timeElements = [];
 ...
 */
exports.convertElapsedTimeToTimeIndex =
  function convertElapsedTimeToTimeIndex(
    ...
    return Math.floor(
      ...
      / (aggregateTimeUnits || MILLISECONDS_PER_SECOND)
    );
  };
